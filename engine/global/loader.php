...
namespace engine\global;
    ...
    //             }
    //             // case 'library': {
    //             //     $libPath = '/engine/library/library';
    //             //     break;
    //             // }
    //             case 'object': {
    //                 $libPath = '/engine/object/object';
    //                 break;
    //             }
    //             // case 'context': {
    //             //     $libPath = '/engine/context/context.';
    //             //     break;
    //             // }
    //             case 'I': {
    //                 $libPath = '/engine/interface/interface.';
    //                 break;
    //             }
    //             case 'configuration': {
    //                 $libName = $pieces[2];
    ...
    //                 $libPath = '/engine/extension/extension';
    //                 break;
    //             }
    //             default: {
    //                 $libPath = '/engine/library/' . $pieces[0];
    //                 break;
    //             }
    //         }
