 ...
 */
define("default/js/plugin/goog", ['default/js/plugin/async', 'default/js/plugin/propertyParser'], function (async, propertyParser) {
    ...
    return {
        load : function(name, req, onLoad, config){
            if (config.isBuild) {
                ...
                req(['default/js/plugin/async!'+ (document.location.protocol === 'https:'? 'https' : 'http') +'://www.google.com/jsapi'], function(){
