...
(function (root, factory) {
  ...
  if (typeof define === "function" && define.amd) {
    ...
    define("default/js/lib/backgrid", ["default/js/lib/underscore", "default/js/lib/backbone"], function (_, Backbone) {
      return (root.Backgrid = factory(_, Backbone));
    });
  } else if (typeof exports === "object") {
    // CommonJS
    module.exports = factory(require("default/js/lib/underscore"), require("default/js/lib/backbone"));
  } else {
    // Browser
