...
class plugin extends basePlugin {
    ...
    public function _getCatalogBrowse () {
        ...
        $data = array();
        $categoryID = \engine\lib\request::fromGET('id', null);
        ...
        foreach ($filterOptionsApplied as $key => $value) {
            $filterOptionsApplied[$key] = \engine\lib\request::fromGET($key, $filterOptions[$key]);
    ...
    public function get_shop_location (&$resp, $req) {
        ...
        $resp['location'] = $this->_getCatalogLocation(\engine\lib\request::fromGET('productID'), \engine\lib\request::fromGET('categoryID'));
    }
