...
class pluginShop extends objectPlugin {
    ...
    private function _getCachedTableData ($tableName) {
        ...
        if (!empty($tableName)) {
            $refreshFromDB = !isset($_SESSION[$tableName]) || $this->_states['changed:' . $stateKey];
            if ($refreshFromDB) {
                $list = $fn();
            } else {
            ...
            $this->_states['changed:' . $stateKey] = false;
        }
    ...
    public function post_shop_category (&$resp, $req) {
        ...
        $this->_states['changed:category'] = true;
    }
    ...
    public function post_shop_origin (&$resp, $req) {
        ...
        $this->_states['changed:origin'] = true;
    }
