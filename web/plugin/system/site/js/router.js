define("plugin/system/site/js/router", [
    'default/js/lib/sandbox',
    'default/js/lib/backbone',
    'plugin/system/site/js/view/menu',
    'default/js/lib/auth',
    ...
    var Router = Backbone.Router.extend({
        ...
        create: function () {
            ...
            require(['plugin/system/site/js/view/userCreate'], function (UserCreate) {
                // create new view
        ...
        summary: function () {
            ...
            var self = this;
            APP.getCustomer().setBreadcrumb();
            require(['plugin/system/site/js/view/userSummary'], function (UserSummary) {
        ...
        password: function () {
            ...
            var self = this;
            APP.getCustomer().setBreadcrumb();
            require(['plugin/system/site/js/view/userPassword'], function (UserPassword) {
                // create new view
        ...
        edit: function () {
            ...
            var self = this;
            APP.getCustomer().setBreadcrumb();
            require(['plugin/system/site/js/view/userEdit'], function (UserEdit) {
                // create new view
        ...
        addresses: function () {
            ...
            // Sandbox.eventNotify('global:breadcrumb:show');
            APP.getCustomer().setBreadcrumb();
            require(['plugin/system/site/js/view/userAddresses'], function (UserAddresses) {
                // create new view
        ...
        delete: function () {
            ...
            // Sandbox.eventNotify('global:breadcrumb:show');
            APP.getCustomer().setBreadcrumb();
            require(['plugin/system/site/js/view/userDelete'], function (UserDelete) {
                // create new viewl
        ...
        showToolbar: function (pageContent) {
            APP.getCustomer().setBreadcrumb();
            require(['plugin/system/site/js/view/userHolder'], function (ViewUserHolder) {
                // create new view
