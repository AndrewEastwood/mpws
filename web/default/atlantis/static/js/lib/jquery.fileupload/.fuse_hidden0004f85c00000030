...
(function (factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        define('default/js/lib/jquery.fileupload/jquery.fileupload-image', [
            'cmn_jquery',
            'default/js/lib/jquery.fileupload/vendor/JavaScript-Load-Image/load-image',
            'default/js/lib/jquery.fileupload/vendor/JavaScript-Load-Image/load-image-meta',
            'default/js/lib/jquery.fileupload/vendor/JavaScript-Load-Image/load-image-exif',
            'default/js/lib/jquery.fileupload/vendor/JavaScript-Load-Image/load-image-ios',
