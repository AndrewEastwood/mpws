<?php /* Smarty version Smarty-3.1.11, created on 2012-10-22 21:38:53
...
?>
        ...
        <?php echo $_smarty_tpl->getSubTemplate ($_smarty_tpl->tpl_vars['CURRENT']->value['OBJECT']->objectTemplatePath_trigger_control, $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 9999, null, array('_type'=>'mpwsLinkAction','_resource'=>'custom','_name'=>((string)smarty_modifier_capitalize($_smarty_tpl->tpl_vars['componentName']->value)).((string)$_smarty_tpl->tpl_vars['_linkTextKey']->value),'_ownerName'=>((string)smarty_modifier_capitalize($_smarty_tpl->tpl_vars['componentName']->value))."Of".((string)smarty_modifier_capitalize($_smarty_tpl->tpl_vars['_ownerName']->value)),'_href'=>"?".((string)$_smarty_tpl->tpl_vars['_filterAction']->value)."#MPWSComponenQuickFilteringID",'_replaceControlNameInLabelBy'=>$_smarty_tpl->tpl_vars['qfEntry']->value,'_action'=>$_smarty_tpl->tpl_vars['_filterAction']->value,'_mode'=>'system'), 0);?>
