<?php /* Smarty version Smarty-3.1.11, created on 2012-09-26 00:56:59
...
" target="blank"><?php echo @MPWS_CUSTOMER;?>
</a></span>
        </div>
        <button type="submit" name="do" value="logout"><?php echo $_smarty_tpl->tpl_vars['SITE']->value->objectProperty_user_formSignoutButtonText;?>
</button>
    </form>
</div><?php }} ?>