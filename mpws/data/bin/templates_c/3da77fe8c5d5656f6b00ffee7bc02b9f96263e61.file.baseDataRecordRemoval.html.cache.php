<?php /* Smarty version Smarty-3.1.11, created on 2012-11-06 12:47:19
         compiled from "/var/www/mpws/web/default/v1.0/template/widget/baseDataRecordRemoval.html" */ ?>
<?php /*%%SmartyHeaderCode:1409352790508fbdfc6117a8-17151589%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3da77fe8c5d5656f6b00ffee7bc02b9f96263e61' => 
    array (
      0 => '/var/www/mpws/web/default/v1.0/template/widget/baseDataRecordRemoval.html',
      1 => 1352198317,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1409352790508fbdfc6117a8-17151589',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.11',
  'unifunc' => 'content_508fbdfc7ae1b3_69194622',
  'variables' => 
  array (
    '_resourceOwner' => 0,
    'CURRENT' => 0,
...
<?php if ($_valid && !is_callable('content_508fbdfc7ae1b3_69194622')) {function content_508fbdfc7ae1b3_69194622($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_capitalize')) include '/mydata/GitHub/web/mpws/engine/system/extension/Smarty-3.1.11/libs/plugins/modifier.capitalize.php';
?><?php $_smarty_tpl->tpl_vars['_widgetName'] = new Smarty_variable("DataRecordRemoval", null, 0);?>
...
<?php $_smarty_tpl->tpl_vars["DTV_CFG"] = new Smarty_variable($_smarty_tpl->tpl_vars['CURRENT']->value['OBJECT']->{"objectConfiguration_widget_dataRecordRemoval".((string)$_smarty_tpl->tpl_vars['CURRENT']->value['SOURCE']['NAME'])}, null, 0);?>
...
">
    ...
    <?php }else{ ?>
        ...
        <?php if ($_smarty_tpl->tpl_vars['CURRENT']->value['SOURCE']['DATA']['PAGE']=='VIEW'){?>
...
?>
            ...
            <div class="MPWSFormFooter">
                ...
                <?php echo $_smarty_tpl->getSubTemplate ($_smarty_tpl->tpl_vars['CURRENT']->value['OBJECT']->objectTemplatePath_control_mpwsFormButtons, $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 9999, null, array('_buttons'=>array('Remove','Cancel'),'_controlOwner'=>$_smarty_tpl->tpl_vars['_widgetName']->value,'_resourceOwner'=>'control'), 0);?>

            </div>
        </form>

        <?php }elseif($_smarty_tpl->tpl_vars['CURRENT']->value['SOURCE']['DATA']['PAGE']=='REMOVED'){?>

            <?php if ($_smarty_tpl->tpl_vars['DTV_CFG']->value['redirectOnRemove']){?>
            ...
            <?php }else{ ?>
                ...
                <?php echo $_smarty_tpl->getSubTemplate ($_smarty_tpl->tpl_vars['CURRENT']->value['OBJECT']->objectTemplatePath_simple_text, $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 9999, null, array('_resourceOwner'=>'display','_key'=>((string)$_smarty_tpl->tpl_vars['_widgetName']->value)."RemovedMain"), 0);?>

                <?php echo $_smarty_tpl->getSubTemplate ($_smarty_tpl->tpl_vars['CURRENT']->value['OBJECT']->objectTemplatePath_simple_text, $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 9999, null, array('_resourceOwner'=>'display','_key'=>((string)$_smarty_tpl->tpl_vars['_widgetName']->value)."RemovedSubText"), 0);?>

            <?php }?>

        <?php }elseif($_smarty_tpl->tpl_vars['CURRENT']->value['SOURCE']['DATA']['PAGE']=='CANCELED'){?>

            <?php if ($_smarty_tpl->tpl_vars['DTV_CFG']->value['redirectOnCancel']){?>
                <?php echo $_smarty_tpl->getSubTemplate ($_smarty_tpl->tpl_vars['CURRENT']->value['OBJECT']->objectTemplatePath_trigger_redirect, $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 9999, null, array('_location'=>$_smarty_tpl->tpl_vars['CURRENT']->value['SOURCE']['DATA']['REFERER']), 0);?>
