<?php /* Smarty version Smarty-3.1.11, created on 2012-10-12 16:16:42
         compiled from "/var/www/mpws/web/default/v1.0/template/component/actionLink.html" */ ?>
<?php /*%%SmartyHeaderCode:131904556950769509005c40-68832879%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '131904556950769509005c40-68832879',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.11',
  'unifunc' => 'content_507695090aacc9_56651137',
  'variables' => 
  array (
    '_action' => 0,
    '_ownerName' => 0,
...
<?php if ($_valid && !is_callable('content_507695090aacc9_56651137')) {function content_507695090aacc9_56651137($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_capitalize')) include '/mydata/GitHub/web/mpws/engine/system/extension/Smarty-3.1.11/libs/plugins/modifier.capitalize.php';
?>
...
<?php if (isset($_smarty_tpl->tpl_vars['_action']->value)){?>
	...
	<?php $_smarty_tpl->tpl_vars["__prop__"] = new Smarty_variable("objectProperty_custom_".((string)$_smarty_tpl->tpl_vars['_ownerName']->value), null, 0);?>
        ...
        <?php }else{ ?>
            <?php $_smarty_tpl->tpl_vars["_linkText"] = new Smarty_variable($_smarty_tpl->tpl_vars['CURRENT']->value['OBJECT']->{"objectProperty_component_actionLink".((string)mb_strtoupper($_smarty_tpl->tpl_vars['_action']->value, 'UTF-8'))}, null, 0);?>
        <?php }?>
