...
define("default/js/lib/htmlComponents", [
    ...
    HtmlComponents.prototype.generateTableCell = function (options) {
        ...
        if (_.isObject(options.cell.tag)) {
            $cell = $(options.cell.tag);
            $cell.attr(options.cell.attr);
        }
        else
            $cell = this.generateTag(options.cell);
    ...
    HtmlComponents.prototype.getModalWindow = function (content, options) {
        ...
        _dialogWnd.open = function (content) {
            ...
            // if (options.appShowAsTooltipFor) {
                // app.log(true, 'render near ', options.appShowAsTooltipFor);
            // }
        }
    ...
    HtmlComponents.prototype.getLink = function (options) {
        ...
        if (_options.attr.class)
            _options.attr.class = "link " + _options.attr.class;
        else
    ...
    HtmlComponents.prototype.getContainerBlock = function (renderMode, content, name) {
        ...
        tag: 'div',
            attr: {
                class: 'container-block render-' + (renderMode || 'normal') + " " + this.setCssScope("container-block", name)
            },
            html: content || false
        });
    }
