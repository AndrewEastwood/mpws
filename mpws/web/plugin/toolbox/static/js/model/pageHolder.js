define("plugin/toolbox/js/model/pageHolder", [
    ...
    var Account = Model.extend({
        ...
        initialize: function () {
            ...
            Sandbox.eventSubscribe('toolbox:status', _.bind(this.getStatus, this));
        },
        getStatus: function (options) {
            ...
            $.post(url, function (responce) {
                ...
                self.set(_data);
                self.trigger('change');
                Sandbox.eventNotify('toolbox:status:received', _data.profile);
            });
        },
        doLogin: function (data) {
            ...
            $.post(url, {credentials: data}, function (responce) {
                ...
                self.set(_data);
                self.trigger('change');
                Sandbox.eventNotify('toolbox:signed:in', _data.profile);
            });
        },
        doLogout: function () {
            // debugger;
            ...
            $.post(url, function (responce) {
                ...
                self.set(_data);
                self.trigger('change');
                Sandbox.eventNotify('toolbox:signed:out', null);
            });
        },
        editProfile: function (data) {
            ...
            $.post(url, {account: data}, function (responce) {
                ...
                self.set(_data);
                self.trigger('change');
                Sandbox.eventNotify('toolbox:profile:updated', _data);
            });
        },
        addAddress: function (data) {
            ...
            $.post(url, {address: data}, function (responce) {
                ...
                self.set(_data);
                self.trigger('change');
                Sandbox.eventNotify('toolbox:profile:address:added', _data);
            });
        },
        updateAddress: function (AddressID, data) {
            ...
            $.post(url, {address: data}, function (responce) {
                ...
                self.set(_data);
                self.trigger('change');
                Sandbox.eventNotify('toolbox:profile:address:updated', _data);
            });
        },
        removeAddress: function (AddressID) {
            ...
            $.post(url, {AddressID: AddressID}, function (responce) {
                ...
                self.set(_data);
                self.trigger('change');
                Sandbox.eventNotify('toolbox:profile:address:removed', _data);
            });
        },
        changePassword: function (password, confirmation) {
            ...
            $.post(url, data, function (responce) {
                ...
                self.set(_data);
                self.trigger('change');
                Sandbox.eventNotify('toolbox:profile:password:updated', _data);
            });
        }
