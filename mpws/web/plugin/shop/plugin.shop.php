...
class pluginShop extends objectPlugin {
    ...
    public function getOrigins_List (array $listOptions = array()) {
        $withRemoved = false;
        if (isset($listOptions['removed'])) {
            $withRemoved = $listOptions['removed'];
        }
        ...
        $dataList = $this->getCustomer()->getDataList($config, $listOptions, $callbacks);
        return $dataList;
    }
    ...
    public function getCategories_List (array $listOptions = array()) {
        $withRemoved = false;
        if (isset($listOptions['removed'])) {
            $withRemoved = $listOptions['removed'];
        }
        $config = configurationShopDataSource::jsapiShopGetCategoryList($withRemoved);
    ...
    public function get_shop_product (&$resp, $req) {
        ...
        $resp["_categories"] = $this->getCategories_List($req->get);
        $resp["_origins"] = $this->getOrigins_List($req->get);
    ...
    public function get_shop_category (&$resp, $req) {
        ...
        $resp["_items"] = $this->getCategories_List(array("limit" => 0));
    }
