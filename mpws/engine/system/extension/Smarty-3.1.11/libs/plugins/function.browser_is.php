...
function smarty_function_browser_is($params, $template)
{
...
while (list($match,$plattform) = each($plattforms)) {
  ...
  if (isset($params['vendor'])) {
     if (strcmp($vendor,$params['vendor'])) {
       if (isset($result)) $template->assign("browser_vendor", $result);
       return "";
    }
  }
  ...
  if (isset($params['plattform'])) {
     if (strcmp($plattform,$params['plattform'])) {
       if (isset($result)) $template->assign("browser_plattform", false);
       return "";
    }
  }
  ...
  if (isset($params['version'])) {
     if ($version != $params['version']) {
       if (isset($result)) $template->assign("browser_version", false);
       return "";
    }
  }
  ...
  if (isset($params['minversion'])) {
     if ((float)$version < (float)$params['minversion']) {
       if (isset($result)) $template->assign("browser_minversion", false);
       return "";
    }
  }
  ...
  if (isset($params['majorversion'])) {
     if ($major_version != (int)$params['majorversion']) {
       if (isset($result)) $template->assign("browser_majorversion", false);
       return "";
    }
  }
  ...
  if (isset($params['minorversion'])) {
     if ($minor_version != (int)$params['minorversion']) {
       if (isset($result)) $template->assign("browser_minorversion", false);
       return "";
    }
  }

  if (isset($result)) {
    $template->assign("browser", $result);
    return "";
  }
