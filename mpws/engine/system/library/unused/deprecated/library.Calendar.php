...
class Calendar
{
    ...
    */
    ...
    /*
        ...
        represents Sunday.
    */
    var $dayNames = array("Нд", "Пн", "Вт", "Ср", "Чт", "Пт", "Сб");

    /*
        The labels to display for the months of the year. The first entry in this array
        represents January.
    */
    var $monthNames = array("Січень", "Лютий", "Березень", "Квітень", "Травень", "Червень",
    ...
    */
    function getMonthHTML($data, $actions, $dateColumn, $m, $y, $dateMask, $showYear = 1)
    {
        ...
        // День
        $day = $this->startDay;
        // Дата за вибраним місяцем та роком
        ...
        // Попередній місяць та рік
    	$prev = $this->adjustDate($month - 1, $year);
    	// Наступний місяць та рік
    	$next = $this->adjustDate($month + 1, $year);
    	// Перехід на попередній місяць
    	$prevMonth = "";
    	// Перехід на наступний місяць
    	$nextMonth = "";
    	// Дія для назви місяця в шапці
    	$monthLink = "";
    	// Дія для номеру року в шапці
    	$yearLink = "";
    	// Шапка календаря
    	$header = "";
