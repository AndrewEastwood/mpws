...
// +--------------------------------------------------
    ...
    $doc_root = (($islinux) ? $_SERVER["DOCUMENT_ROOT"] : ucfirst($_SERVER["DOCUMENT_ROOT"])) . '/data/';
    $script_filename = '/service/phpFileManager.php';//$doc_root.$_SERVER["PHP_SELF"];
    //$path_info = pathinfo($script_filename);
    $path_info = pathinfo($doc_root . '/phpFileManager.php');
// +--------------------------------------------------
// | Config
// +--------------------------------------------------
    $cfg = new config();
...
function frameset(){
    ...
    <frameset cols=\"300,*\" framespacing=\"0\">
        <frameset rows=\"0,*\" framespacing=\"0\" frameborder=no>
            <frame src=\"".$script_filename."?frame=1\" name=frame1 border=\"0\" marginwidth=\"0\" marginheight=\"0\" scrolling=no>
            <frame src=\"".$script_filename."?frame=2\" name=frame2 border=\"0\" marginwidth=\"0\" marginheight=\"0\">
        </frameset>
        <frame src=\"".$script_filename."?frame=3\" name=frame3 border=\"0\" marginwidth=\"0\" marginheight=\"0\">
    </frameset>
    ";
    echo "</html>";
}
