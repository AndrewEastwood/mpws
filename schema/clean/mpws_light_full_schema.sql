...
CREATE TABLE `mpws_customer` (
  ...
  `SnapshotURL` varchar(300) COLLATE utf8_bin NOT NULL DEFAULT '',
  `SitemapURL` varchar(500) COLLATE utf8_bin NOT NULL DEFAULT '',
...
--
-- Table structure for table `mpws_emails`
--

DROP TABLE IF EXISTS `mpws_emails`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mpws_emails` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `mpws_emails_ibfk_1` FOREIGN KEY (`CustomerID`) REFERENCES `mpws_customer` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE
...
) ENGINE=InnoDB AUTO_INCREMENT=781 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=41593 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=22758 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `shop_products` (
  ...
  `Name` varchar(300) CHARACTER SET utf8 NOT NULL,
  `ExternalKey` varchar(600) COLLATE utf8_bin NOT NULL DEFAULT '',
  ...
  `Status` enum('DISCOUNT','ACTIVE','WAITING','PREORDER','DEFECT','ARCHIVED','REMOVED') COLLATE utf8_bin NOT NULL DEFAULT 'ACTIVE',
  `SearchText` varchar(300) CHARACTER SET utf8 NOT NULL,
  `DateCreated` datetime NOT NULL,
  `DateUpdated` datetime NOT NULL,
  PRIMARY KEY (`ID`),
...
) ENGINE=InnoDB AUTO_INCREMENT=1933 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='shop products';
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `backupProductPrevPrice` BEFORE UPDATE ON `shop_products`
...
CREATE TABLE `shop_settingsAlerts` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `CustomerID` int(11) NOT NULL,
  `AllowAlerts` tinyint(1) DEFAULT '0',
  `NewProductAdded` int(1) NOT NULL DEFAULT '0',
  `ProductPriceGoesDown` int(1) NOT NULL DEFAULT '0',
  `PromoIsStarted` int(1) NOT NULL DEFAULT '0',
  `AddedNewOrigin` int(1) NOT NULL DEFAULT '0',
  `AddedNewCategory` int(1) NOT NULL DEFAULT '0',
  `AddedNewDiscountedProduct` int(1) NOT NULL DEFAULT '0',
  `ParamsNewProductAdded` text COLLATE utf8_bin,
  `ParamsProductPriceGoesDown` text COLLATE utf8_bin,
  `ParamsPromoIsStarted` text COLLATE utf8_bin,
  `ParamsAddedNewOrigin` text COLLATE utf8_bin,
  `ParamsAddedNewCategory` text COLLATE utf8_bin,
  `ParamsAddedNewDiscountedProduct` text COLLATE utf8_bin,
  PRIMARY KEY (`ID`),
  KEY `CustomerID` (`CustomerID`),
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `searchProducts`(IN `searchText` TEXT, IN `cid` INT)
BEGIN
...
-- Dump completed on 2015-07-06  0:06:19
